...
export const COMPONENTS: Record<ComponentKind, ComponentDefinition> = {
  ...
  sales: { kind: 'sales', name: 'Oficina de ventas', shortName: 'Ventas', description: 'Vende 50 E/s y se recalibra con cada tier térmico.', icon: '₡', cost: 250, capacity: 0, salesRate: 50 },
