...
describe('promoted official balance', () => {
  it('matches every global value from the promoted Debug profile', () => {
    ...
    expect(Object.fromEntries(Object.entries(TECHNOLOGIES).map(([key, technology]) => [key, technology.cost]))).toEqual({ solar: 150, thermal: 60_000, logistics: 100_000, automation: 150_000, thorium: 300_000, fusion: 20_000_000, expansion: 100_000_000 })
