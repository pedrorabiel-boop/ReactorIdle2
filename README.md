...
- **Lab** contiene el árbol tecnológico. Torio desbloquea en un solo avance el reactor, la red térmica completa, el controlador, Oficina de ventas II e I+D II; Fusión desbloquea la Turbina II y la Tubería II. Los edificios II conservan niveles y valores independientes, editables en Debug; ningún desbloqueo altera la potencia ni la capacidad de la Turbina I. **Contratos** contiene los bonos opcionales y el protocolo de arranque; el **Menú** superior derecho contiene pausa, velocidad, sectores, telemetría y guardado.
